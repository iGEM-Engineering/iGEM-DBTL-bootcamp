...
You have the general genetic circuit design in mind, so let's start ordering!
> 
...
More specifically, the DBTL Bootcamp will take you through designing, building, testing, and analyzing characterization data for three GFP reporter constructs of varying promoter strength. 
Your iGEM project’s aim, DBTL cycle, as well as the tools and techniques used at each stage, will likely be more complex than this, but we hope you will find some useful approaches and tools that you can apply to your project.
...
#### Test Module
In the [Test Module](/1_test/1_test.md), you will measure GFP expression with a plate reader. 
...
#### Learn Module
Finally, in the [Learn Module](/1_learn/1_learn.md), you will analyze the data produced in the Test Module.
...
These have all been added to the [iGEM Registry](https://parts.igem.org/) (Registry for short), so we have included links to their respective part pages.
...
These five promoters have been used in previous InterLaboratory studies, and they cover a range of promoter strengths, from strong to weak. We will discuss these promoters further, including available data, in the Design Module’s Modeling section.


### RBS
The RBS you will be using is a variant of BBa_B0034, BBa_J428038. 

| Part Name | Plasmid Backbone |
| --- | --- |
| [BBa_J428038](https://parts.igem.org/Part:BBa_J428038) | [pSB1C5SB](https://parts.igem.org/Part:pSB1C5SB) |

A key difference here is that this variant also includes a 6bp downstream of the Shine-Dalgarno sequence. 
...
### GFP
The GFP you will be using is a Type IIS variant of [BBa_E0040](https://parts.igem.org/Part:BBa_E0040), BBa_J119040. 
...
This variant includes a `5’ AA` sequence, that when taken with the `5’` fusion site for terminators (`GCTT`) would create a stop codon preceding the terminator (`GCT TAA BBa_B0015`).
